...
try {
    ...
    $needsLibraryRestart = $All -or ($changed | Where-Object { $_ -match '^(scripts/pi/(mabeltv-library(-classic)?\.(py|html)|mabeltv_backend/|mabeltv-offline\.js|service-worker\.js|hls\.min\.js|mabeltv-manifest\.json|mabeltv-icon\.png|apple-touch-icon\.png|icons/|portal/)|packaging/linux/mabeltv-library\.service$)' })

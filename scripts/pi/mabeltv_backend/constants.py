...
MY_TV_DISCOVERY_CACHE_SECONDS = 24 * 60 * 60
MY_TV_METADATA_CACHE_SECONDS = 24 * 60 * 60
MY_TV_PROVIDER_CACHE_SECONDS = 7 * 24 * 60 * 60
MY_TV_PROVIDER_MAX_CACHE_SECONDS = 29 * 24 * 60 * 60

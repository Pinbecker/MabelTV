...
assert FIXTURE_DATA_SPEC and FIXTURE_DATA_SPEC.loader
fixture_data = importlib.util.module_from_spec(FIXTURE_DATA_SPEC)
FIXTURE_DATA_SPEC.loader.exec_module(fixture_data)
LIBRARY_PAYLOAD = fixture_data.LIBRARY_PAYLOAD
...
class FixtureLibrary:
    ...
    @staticmethod
    def usb_import_status(job_id: str) -> dict[str, Any]:
        return {"id": job_id, "status": "complete", "message": "Complete"}

    @staticmethod
    def offline_preparation_status(job_id: str) -> dict[str, Any]:
        return {"id": job_id, "status": "error", "message": "Unavailable in fixture"}

...
Describe the owned component or responsibility changed and the user-visible
effect, if any.

## Architecture and safety

- [ ] The change is in the existing owner, or a focused owner was extracted.
- [ ] Shared UI behaviour reuses the canonical component/token/icon contract.
...
List the checks run and any physical TV/Pi acceptance performed.
